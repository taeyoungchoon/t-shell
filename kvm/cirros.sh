...
virt-install   --name test-instance   --memory 512   --vcpus 1   --import   --disk=cirros-image.qcow2,format=qcow2,bus=virtio --network network=default --graphics vnc,keymap=local --noautoconsole
